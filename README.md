...
Demo: https://files-storage-app.netlify.app/
...
Requires a [Supabase](https://supabase.com) project with:

- Storage buckets: `files` (public) and `private`
- Email authentication enabled
- A `profiles` table in the public schema (`id`, `avatar` columns)
